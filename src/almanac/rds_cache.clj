...
;; TODO: find a way to make db configurable explicit
;; through function arguments
;; currently isn't possible because of global
;; db and entity creation using macroses :(
(defn fullcontact-cache []
  (reify KeyValueStore
    (get-value [_ key]
      (get-info key))
